document.addEventListener("DOMContentLoaded", async () => {
  ...
  async function loadSkills() {
    try {
      const response = await fetch(`https://campus-connect-1q2c.onrender.com/api/skills/${user._id}`);
  ...
  addSkillBtn.addEventListener("click", async () => {
    ...
    try {
      const response = await fetch("https://campus-connect-1q2c.onrender.com/api/skills", {
        method: "POST",
