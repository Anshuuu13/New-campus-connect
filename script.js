...
const dashboardItems = [
 ...
 { icon: "🤝", label: "Team Requests", tag: "Projects", link: "team.html" },
  ...
  { icon: "🧑‍🏫", label: "Mentorship Requests", tag: "Guidance", link: "mentorship.html" },
  { icon: "📍", label: "Classroom Finder", tag: "Campus", link: "classrooms.html" },
{ icon: "📝", label: "PYQs", tag: "Academics", link: "pyqs.html" },
